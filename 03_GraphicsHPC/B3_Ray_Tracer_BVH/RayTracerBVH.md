...
Rays in the same warp follow different tree paths through the BVH. This is inevitable — the profiler will show it after you hit the gate. See [Toolbox: Thread Divergence](../../05_Toolbox/ThreadDivergence/ThreadDivergence.md) for mitigation strategies.
