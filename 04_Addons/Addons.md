...
| [4.5 Voxel Mapping](4_5_Voxel_Mapping/VoxelMapping.md) | Track B (B3) + Track C (C3) + ROS 2 Humble+ | Asset: `assets/lidar_sample.bag` |
| [4.6 FFmpeg Pipeline](4_6_FFmpeg_Pipeline/FFmpegPipeline.md) | Track A (A4) | `sudo apt install libavcodec-dev libavformat-dev libavutil-dev` · Asset: `assets/sample.mp4` |
