...
## Build & Run
```bash
cd 05_Toolbox/06_Generic_Kernel_Templates
...
## Used In
- [Track A — 02_YUV_Pipeline](../../02_Multimedia/02_YUV_Pipeline/YUVPipeline.md) (uchar vs float YUV conversion kernel)
- [Track B — 02_Ray_Tracer_BVH](../../03_GraphicsHPC/02_Ray_Tracer_BVH/RayTracerBVH.md) (float/half ray payload type selection)
- [Track C — 03_Perception_Node](../../04_Robotics/03_Perception_Node/PerceptionNode.md) (multi-type point cloud processing kernels)
