...
## Build & Run
```bash
cd 99_Toolbox/LocalMemory
cmake -B build && cmake --build build
./build/local_mem_demo --kernel blur --radius 5 --width 1920 --height 1080
```
...
## Used In
- [Track A — A2_YUV_Pipeline](../../02_Projects/A_Multimedia/Multimedia.md#a2_yuv_pipeline--see-what-the-camera-actually-sends)
