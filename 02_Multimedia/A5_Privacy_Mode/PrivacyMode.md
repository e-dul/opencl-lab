...
> ⚠️ This module overlaps significantly with A3_1 (T-API + DNN) and the A4 Stretch Challenge. The unique teaching point is `global_work_offset`. Consider doing the A4 Stretch Challenge instead if you have completed A4.

## Prerequisites (delta from module index)

- [A.3.1 — OpenCV DNN](../A3_1_OpenCV_DNN/OpenCVDNN.md) completed (DNN_TARGET_OPENCL, T-API concepts).
