...
- **Required**: [Toolbox: Local Memory](../../05_Toolbox/01_Local_Memory/LocalMemory.md) — the LDS tile pattern used here is the same one from that tool (LDS = Local Data Store, i.e., `__local` shared memory in OpenCL)
