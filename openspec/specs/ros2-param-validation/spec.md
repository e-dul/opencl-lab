# Spec: ROS 2 Parameter Validation

## Purpose
Defines requirements for ROS 2 parameter declaration, range constraints, validation callbacks, and live-update behaviour across C2 CostmapNode, C3 PerceptionNode, and VoxelMappingNode.
