...
## Purpose
Defines requirements for the GPU-side LBVH construction pipeline: scene AABB reduction, Morton code generation, binary radix tree construction (Karras 2012), and bottom-up AABB fitting.
