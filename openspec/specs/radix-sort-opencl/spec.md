# Spec: Radix Sort (OpenCL)

## Purpose
Defines requirements for the GPU radix sort used to order Morton codes prior to LBVH construction: 4-pass LSD sort, per-pass histogram, Blelloch prefix scan, scatter with key-value association, and a CPU reference self-test.
