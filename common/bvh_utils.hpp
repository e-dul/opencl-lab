...
// ---------------------------------------------------------------------------
// TriangleSoa — Structure-of-Arrays layout for coalesced GPU reads.
//
// WHY SoA: when N threads each read v0x for different triangles, a single
// cache line covers 16 consecutive floats (16 triangles). AoS would force
// 1 cache line per triangle — 16× more bandwidth on v0x alone.
// Used by B3 (BVH Dynamic) and B4 (LBVH) ray tracers.
// ---------------------------------------------------------------------------
struct TriangleSoa {
