...
Instruct the @auditor to use the `technical-audit` skill to review "$1/" module. The auditor must use web search to validate technical claims and identify redundancies.
