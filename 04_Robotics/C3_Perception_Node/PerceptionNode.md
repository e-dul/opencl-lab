...
To reach < 5 ms you will likely need the loaned path. The standard path adds 0.8–1.5 ms on a 1.6 MB message. Same principle as [Toolbox: Zero-Copy](../../05_Toolbox/ZeroCopy/ZeroCopy.md).
