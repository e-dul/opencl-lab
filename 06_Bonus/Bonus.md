...
| [CLBlast MatMul](01_CLBlast_MatMul/) | GPU matrix multiplication via CLBlast (drop-in BLAS) | Module 1 sufficient |
| [Device Enqueue](02_Device_Enqueue/) | OpenCL 2.0 device-side enqueue (kernel spawning kernels) | OpenCL 2.0+ device required |
